...
interface Rand {
    ...
    /**
     * @return random element from the specified array, or null if the list was empty.
     */
    ...
    fun nextDouble3(min: Double3 = Double3.MINUS_ONES,
                    ...
                    out: MutableDouble3 = MutableDouble3()): MutableDouble3 {
    ...
    companion object {
         ...
         */
        fun createDefault(seed: Long = System.nanoTime()): Rand = XoroShiro(seed)
