...
abstract class BaseRand(seed: Long = System.nanoTime(),
                        protected val seedHashingFunction: Hash = BaseRand.DEFAULT_SEED_HASHING_FUNCTION) : Rand {
    ...
    override fun setSeed(seed: Long, vararg additionalSeeds: Long) {
        ...
        var hashedSeed = seedHashingFunction.hash(seed)

        for (additionalSeed in additionalSeeds) {
            hashedSeed = seedHashingFunction.hash(hashedSeed)
            hashedSeed = hashedSeed xor seedHashingFunction.hash(additionalSeed)
        }
    ...
    override fun setSeed(seed: Float, vararg additionalSeeds: Float) {
        ...
        var hashedSeed = seedHashingFunction.hash(java.lang.Float.floatToIntBits(seed).toLong())

        for (additionalSeed in additionalSeeds) {
            hashedSeed = seedHashingFunction.hash(hashedSeed)
            hashedSeed = hashedSeed xor seedHashingFunction.hash(java.lang.Float.floatToIntBits(additionalSeed).toLong())
        }
    ...
    override fun setSeed(seed: Double, vararg additionalSeeds: Double) {
        ...
        var hashedSeed = seedHashingFunction.hash(java.lang.Double.doubleToLongBits(seed))

        for (additionalSeed in additionalSeeds) {
            hashedSeed = seedHashingFunction.hash(hashedSeed)
            hashedSeed = hashedSeed xor seedHashingFunction.hash(java.lang.Double.doubleToLongBits(additionalSeed))
        }
     ...
     */
    protected abstract fun setHashedSeed(seed: Long)
