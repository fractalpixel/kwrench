package org.kwrench.geometry.grid
...
import org.kwrench.geometry.rectangle.Rect
...
class RectangularGrid(
    ...
    inline fun getCellAreaFromCell(cell: Int2, areaOut: MutableRect = MutableRect()): MutableRect = getCellAreaFromCell(cell.x, cell.y, areaOut)
    inline fun getCellAreaFromCell(cellX: Int, cellY: Int, areaOut: MutableRect = MutableRect()): MutableRect {
        areaOut.set(
