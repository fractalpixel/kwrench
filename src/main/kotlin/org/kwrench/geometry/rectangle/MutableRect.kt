...
import org.kwrench.geometry.double2.ImmutableDouble2
...
class MutableRect(x: Double,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        if (java.lang.Double.compare(other.x, x) != 0) return false
        if (java.lang.Double.compare(other.y, y) != 0) return false
        if (java.lang.Double.compare(other.w, w) != 0) return false
        if (java.lang.Double.compare(other.h, h) != 0) return false
