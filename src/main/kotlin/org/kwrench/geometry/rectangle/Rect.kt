package org.kwrench.geometry.rectangle

import org.kwrench.geometry.double2.Double2
import org.kwrench.geometry.double2.MutableDouble2
import org.kwrench.math.distance
import org.kwrench.math.distanceSquared
...
interface Rect {
     ...
     * @return outputPos
     */
    fun map(sourcePos: MutableDouble2, sourceRange: Rect = ImmutableRect.ZERO_TO_ONE, outputPos: MutableDouble2 = sourcePos, clamp: Boolean = false, smooth: Boolean = false): Double2 {
        outputPos.x = map(sourcePos.x, sourceRange.minX, sourceRange.maxX, minX, maxX, clamp, smooth)
        outputPos.y = map(sourcePos.y, sourceRange.minY, sourceRange.maxY, minY, maxY, clamp, smooth)
        return outputPos
    }
