...
abstract class UpdatingWithStrategy(var updateStrategy: UpdateStrategy? = null) : Updating {
    ...
    /**
     * Create a UpdatingWithStrategy with two or more build strategies, applied in reverse order (last added strategies are executed first).
     */
    protected constructor(firstUpdateStrategy: UpdateStrategy,
                          secondUpdateStrategy: UpdateStrategy,
                          vararg additionalUpdateStrategies: UpdateStrategy
    ) : this(ChainedStrategy(firstUpdateStrategy, secondUpdateStrategy, *additionalUpdateStrategies)) {}
