...
public class Bag<E> implements ImmutableBag<E> {
    ...
    public Bag(int capacity) {
        data = (E[])java.lang.reflect.Array.newInstance(Object.class, capacity);
    }

    /**
     * Constructs an empty Bag of the specified type with the specified initial capacity.
     * @param capacity the initial capacity of Bag
     */
    public Bag(Class<E> type, int capacity) {
        data = (E[])java.lang.reflect.Array.newInstance(type, capacity);
    }
    ...
    /**
     * Sets the element at the specified position in this Bag to null, and return the value
     * that was at that index.
     * </p>
     * @param index the index of element to be cleared
     * @return previous element at the specified index, or null if the index is out of range.
     */
    public E clear(int index) {
        E e = data[index];
     ...
     * without updating size. Can be used when the operation is known to be safe to avoid a slight overhead.
    ...
    /**
     * Check if an item, if added at the given index will fit into the bag.
     * <p>
